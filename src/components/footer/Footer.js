...
const Footer = () => {
    return (
        <div className="footer grid grid-cols-1 lg:grid-cols-2 lg:w-full h-full lg:h-screen pt-[2rem] lg:pt-[6rem] bg-[#FBFDFF]">
            <div className="footer__left pl-[2rem] lg:pl-[7rem] pr-[1rem] lg:pr-[5rem] bg-[#383F50] lg:bg-[#FBFDFF]">
                ...
                <div className="footer__left__social w-3/4 lg:w-2/4 grid grid-cols-3 mb-[2rem]">
